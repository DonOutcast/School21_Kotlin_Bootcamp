...
fun main(args: Array<String>) {
    ...
    val incident = Incident(xyIncident[0].toInt(), xyIncident[1].toInt(), Desciption.values().random().description, Phone.values().random().phone, IncidentType.values().random().type)
